...
const loginUser = asyncHandler(async (req, res) => {
    // Take data from frontend i.e req.body
    // Validate if any field is empty
    // Check user in the database 
    // if exists check password
    // if correct generate an access token and refresh token
    // return them in cookie to frontend
...
const logoutUser = asyncHandler(async (req, res) => {
    // remove access and refresh token and clear cookies
